#[cfg(test)]
mod tests {
    use crate::unittest_helpers::{init_helper_with_config, extract_error_msg, set_contract_status, mint_nft1_alice_grant_bob_charlie, mint_nft2_alice_grant_charlie, mint_nft3_alice_grant_bob, mint_nft4_bob_grant_alice, mint_nft5_bob_grant_alice_charlie, mint_nft6_bob_grant_alice, mint_nft7_charlie_grant_alice, mint_nft8_charlie, grant_all};
